...
if(account_id !=""){login_success();}
 ...
 function fetch_database(){
   db.transaction(function(tx){
     ...
     tx.executeSql(query, ["T-shirt", "Description 01"], fetch_transaction_sucess("Category 01"),
     transaction_error);
     tx.executeSql(query, ["Suit", "Description 02"], fetch_transaction_sucess("Category 02"),
     transaction_error);
     tx.executeSql(query, ["swimsuit", "Description 03"], fetch_transaction_sucess("Category 03"),
     transaction_error);
   });
 }
    ...
    product_list.innerHTML += `
      <div class="col-6 col-sm-4 col-lg-3 mt-3 p-3 product">
        <div class="product-img">
          <img src="image/sp4.jpg"width="100%" alt="${product.name}" > 
        </div>
